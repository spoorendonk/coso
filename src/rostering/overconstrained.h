...
struct RosteringOverconstrainedConfig {
...
[[nodiscard]] int64_t rostering_overconstrained_penalty(
...
[[nodiscard]] bool rostering_overconstrained_feasible(
    RosteringCostEvaluator const& eval, std::vector<std::vector<int>> const& schedule);
