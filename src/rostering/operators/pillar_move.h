...
public:
    ...
    [[nodiscard]] bool find_best_move(RosteringSolution const& sol) {
        best_ = Move{};
    ...
    void apply(RosteringSolution& sol) const {
    ...
    /// from_emp to to_emp.
    [[nodiscard]] static int evaluate(RosteringSolution const& sol, int from_emp, int to_emp,
                                      int start, int len) {
        auto& mut = const_cast<RosteringSolution&>(sol);
    ...
    [[nodiscard]] static std::vector<Move> enumerate(RosteringSolution const& sol,
                                                     int max_len = 7) {
...
public:
    ...
    [[nodiscard]] static int evaluate(RosteringSolution const& sol, int emp1, int emp2, int start,
                                      int len) {
        auto& mut = const_cast<RosteringSolution&>(sol);
...
public:
    ...
    static void apply_rotation(RosteringSolution& sol, int e0, int e1, int e2, int start,
                               int len) {
        for (int d = start; d < start + len; ++d) {
            int s0 = sol.get(e0, d);
            int s1 = sol.get(e1, d);
    ...
    [[nodiscard]] static int evaluate(RosteringSolution const& sol, int e0, int e1, int e2,
                                      int start, int len) {
        auto& mut = const_cast<RosteringSolution&>(sol);
...
inline int pillar_vnd(RosteringSolution& sol, int max_block_len = 7, int max_rotate_block = 3) {
    int total_delta = 0;
    bool improved = true;
