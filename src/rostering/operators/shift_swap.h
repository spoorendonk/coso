...
public:
    ...
    void apply(RosteringSolution& sol) const { sol.swap(best_.emp1, best_.emp2, best_.day); }
    ...
    [[nodiscard]] static int evaluate(RosteringSolution const& sol, int emp1, int emp2, int day) {
