...
StopCriterion::StopCriterion(double time_limit_s) : StopCriterion(time_limit_s, 0, 0) {}

StopCriterion::StopCriterion(double time_limit_s, int max_iter, int max_no_improve)
    : start_(Clock::now()),
      time_limit_s_(time_limit_s),
      max_iter_(max_iter),
      max_no_improve_(max_no_improve) {}

void StopCriterion::set_work_limit(WorkUnits const* work, uint64_t max_work_ticks) {
    work_ = work;
