...
public:
    ...
    [[nodiscard]] virtual int evaluate_delta(
        AssignmentData const& data,
...
public:
    explicit MaxConsecutiveConstraint(int penalty = 10000)
        : penalty_(penalty)
    {
    }
...
public:
    explicit MinRestConstraint(int penalty = 10000)
        : penalty_(penalty)
    {
    }
...
public:
    explicit DemandConstraint(int understaffing_penalty = 1000,
                              int overstaffing_penalty  = 100)
        : under_penalty_(understaffing_penalty)
        , over_penalty_(overstaffing_penalty)
    {
    }
...
public:
    explicit ForbiddenSequenceConstraint(int penalty = 10000)
        : penalty_(penalty)
    {
    }
