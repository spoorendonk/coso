...
int MaxConsecutiveConstraint::employee_cost(
    int max_consec,
...
int MaxConsecutiveConstraint::evaluate(
    AssignmentData const& data,
...
int MaxConsecutiveConstraint::evaluate_delta(
    AssignmentData const& data,
    std::vector<std::vector<int>> const& schedule,
    AssignmentMove const& move) const
{
...
int MinRestConstraint::check_rest(
    AssignmentData const& data,
    int min_rest, int s1, int s2) const
{
...
int MinRestConstraint::evaluate(
    AssignmentData const& data,
    std::vector<std::vector<int>> const& schedule) const
{
...
int MinRestConstraint::evaluate_delta(
    AssignmentData const& data,
    std::vector<std::vector<int>> const& schedule,
    AssignmentMove const& move) const
{
...
int DemandConstraint::count_assigned(
    AssignmentData const& data,
    std::vector<std::vector<int>> const& schedule,
    int shift_type, int day) const
{
...
int DemandConstraint::evaluate_delta(
    AssignmentData const& data,
    std::vector<std::vector<int>> const& schedule,
    AssignmentMove const& move) const
{
    ...
    auto has_skill = [&](int emp, int shift_type) -> bool {
        ...
        return std::find(skills.begin(), skills.end(), dem.required_skill)
               != skills.end();
    };
...
int ForbiddenSequenceConstraint::employee_cost(
    AssignmentData const& data,
    std::vector<int> const& row,
    int horizon) const
{
...
int ForbiddenSequenceConstraint::evaluate(
    AssignmentData const& data,
    std::vector<std::vector<int>> const& schedule) const
{
    int cost = 0;
...
int ForbiddenSequenceConstraint::evaluate_delta(
    AssignmentData const& data,
    std::vector<std::vector<int>> const& schedule,
    AssignmentMove const& move) const
{
...
int PreferenceConstraint::evaluate(
    AssignmentData const& data,
    std::vector<std::vector<int>> const& schedule) const
{
    int cost = 0;
...
int PreferenceConstraint::evaluate_delta(
    AssignmentData const& data,
    std::vector<std::vector<int>> const& schedule,
    AssignmentMove const& move) const
{
