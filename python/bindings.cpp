...
NB_MODULE(_coso, m) {
    ...
    nb::class_<coso::RoutingModel>(m, "RoutingModel")
        ...
        .def("add_depot",
             nb::overload_cast<double, double, coso::DepotParams>(
                 &coso::RoutingModel::add_depot),
             "x"_a, "y"_a, "params"_a = coso::DepotParams{})

        // add_depot: explicit id
        .def("add_depot_id",
             nb::overload_cast<int, coso::DepotParams>(
                 &coso::RoutingModel::add_depot),
             "id"_a, "params"_a = coso::DepotParams{})

        // add_vehicle_type
        .def("add_vehicle_type",
             &coso::RoutingModel::add_vehicle_type,
             "count"_a, "params"_a = coso::VehicleTypeParams{})

        // add_client: coordinate-based
        .def("add_client",
             nb::overload_cast<double, double, coso::ClientParams>(
                 &coso::RoutingModel::add_client),
             "x"_a, "y"_a, "params"_a = coso::ClientParams{})

        // add_client: explicit id
        .def("add_client_id",
             nb::overload_cast<int, coso::ClientParams>(
                 &coso::RoutingModel::add_client),
             "id"_a, "params"_a = coso::ClientParams{})

        // add_pickup / add_delivery / add_request
        .def("add_pickup",
             nb::overload_cast<double, double, coso::ClientParams>(
                 &coso::RoutingModel::add_pickup),
             "x"_a, "y"_a, "params"_a = coso::ClientParams{})
        .def("add_delivery",
             nb::overload_cast<double, double, coso::ClientParams>(
                 &coso::RoutingModel::add_delivery),
             "x"_a, "y"_a, "params"_a = coso::ClientParams{})
        .def("add_request",          &coso::RoutingModel::add_request,
             "pickup"_a, "delivery"_a)
        .def("add_pickup_delivery",  &coso::RoutingModel::add_pickup_delivery,
             "pickup"_a, "delivery"_a)
        .def("add_client_group",     &coso::RoutingModel::add_client_group)

        // Distance / duration matrices
        .def("set_distance",         &coso::RoutingModel::set_distance,
             "from_node"_a, "to_node"_a, "dist"_a)
        .def("set_duration",         &coso::RoutingModel::set_duration,
             "from_node"_a, "to_node"_a, "dur"_a)
        .def("set_profile",          &coso::RoutingModel::set_profile,
             "profile"_a)
        .def("set_profile_distance", &coso::RoutingModel::set_profile_distance,
             "profile"_a, "from_node"_a, "to_node"_a, "dist"_a)
        .def("set_profile_duration", &coso::RoutingModel::set_profile_duration,
             "profile"_a, "from_node"_a, "to_node"_a, "dur"_a)
        .def("set_cost_matrix",      &coso::RoutingModel::set_cost_matrix,
             "profile"_a, "from_node"_a, "to_node"_a, "cost"_a)

        // Warm start
        .def("set_initial_routes",   &coso::RoutingModel::set_initial_routes,
             "routes"_a)
        .def("pin",                  &coso::RoutingModel::pin,
             "client_id"_a)

        // Solve
        .def("solve",                &coso::RoutingModel::solve,
             "time_limit"_a);
