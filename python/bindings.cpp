...
NB_MODULE(_coso, m) {
    ...
    nb::class_<coso::RoutingModel>(m, "RoutingModel")
        ...
        // add_depot
        .def("add_depot", &coso::RoutingModel::add_depot, "x"_a, "y"_a,
        ...
        // add_client
        .def("add_client", &coso::RoutingModel::add_client, "x"_a, "y"_a,
             "params"_a = coso::ClientParams{})

        // add_pickup / add_delivery / add_request
        .def("add_pickup", &coso::RoutingModel::add_pickup, "x"_a, "y"_a,
             "params"_a = coso::ClientParams{})
        .def("add_delivery", &coso::RoutingModel::add_delivery, "x"_a, "y"_a,
             "params"_a = coso::ClientParams{})
