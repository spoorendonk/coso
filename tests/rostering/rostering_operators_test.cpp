...
TEST_CASE("ShiftSwap: finds improving swap", "[rostering][operators]") {
...
TEST_CASE("ShiftSwap: no improving swap when optimal", "[rostering][operators]") {
    auto data = make_instance();
...
TEST_CASE("ShiftSwap: delta accuracy", "[rostering][operators]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
...
TEST_CASE("ShiftSwap: skips identical assignments", "[rostering][operators]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
...
TEST_CASE("ShiftMove: finds improving move", "[rostering][operators]") {
    auto data = make_instance();
...
TEST_CASE("ShiftMove: only moves to unassigned slots", "[rostering][operators]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
...
TEST_CASE("ShiftMove: delta accuracy", "[rostering][operators]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
...
TEST_CASE("BlockSwap: finds improving block swap", "[rostering][operators]") {
    auto data = make_instance();
...
TEST_CASE("BlockSwap: minimum block length is 2", "[rostering][operators]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
...
TEST_CASE("BlockSwap: delta accuracy", "[rostering][operators]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
...
TEST_CASE("BlockSwap: skips blocks with identical assignments", "[rostering][operators]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    RosteringSolution sol(data, eval);
...
TEST_CASE("BlockSwap: respects max_block_len", "[rostering][operators]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
