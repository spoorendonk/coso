...
TEST_CASE("PillarMove: finds improving move", "[rostering][pillar]") {
...
TEST_CASE("PillarMove: target must be unassigned", "[rostering][pillar]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
...
TEST_CASE("PillarMove: delta accuracy", "[rostering][pillar]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
...
TEST_CASE("PillarMove: source must be assigned", "[rostering][pillar]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
...
TEST_CASE("PillarSwap: finds improving swap", "[rostering][pillar]") {
    auto data = make_instance();
...
TEST_CASE("PillarSwap: both employees must be assigned", "[rostering][pillar]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
...
TEST_CASE("PillarSwap: skips identical blocks", "[rostering][pillar]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    RosteringSolution sol(data, eval);
...
TEST_CASE("PillarSwap: delta accuracy", "[rostering][pillar]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    auto sol = make_populated_solution(data, eval);
...
TEST_CASE("PillarRotate: finds improving rotation with 3 employees", "[rostering][pillar]") {
    auto data = make_instance();
...
TEST_CASE("PillarRotate: skips trivial rotations", "[rostering][pillar]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    RosteringSolution sol(data, eval);
...
TEST_CASE("PillarRotate: delta accuracy", "[rostering][pillar]") {
    auto data = make_instance();
    RosteringCostEvaluator eval(data);
    RosteringSolution sol(data, eval);
...
TEST_CASE("pillar_vnd: improves solution", "[rostering][pillar]") {
    auto data = make_instance();
