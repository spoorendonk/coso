...
static void run_local_search(coso::RosteringSolution& sol, int max_iters = 200) {
...
static void run_nrp_benchmark(const std::string& file, int expected_employees,
    ...
    coso::RosteringCostEvaluator::Weights weights;
    weights.understaffing = 100;
    weights.overstaffing = 1;
    coso::RosteringCostEvaluator evaluator(data, weights);
