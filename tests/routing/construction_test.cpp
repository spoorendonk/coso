...
TEST_CASE("NN: tight capacity uses correct number of vehicles",
          "[construction][nn]")
{
...
TEST_CASE("CW: all clients assigned in line instance",
          "[construction][cw]")
{
    auto data = make_line_instance();
    CostEvaluator eval;
...
TEST_CASE("CW: cluster instance groups nearby clients",
          "[construction][cw]")
{
    auto data = make_cluster_instance();
    CostEvaluator eval;
...
TEST_CASE("CW: tight capacity uses correct number of vehicles",
          "[construction][cw]")
{
    auto data = make_tight_instance();
    CostEvaluator eval;
